...
export default function TestimonialBlock() {
  ...
  return (
    <div>
      ...
      {/* 🟨 Mid-page CTA after property description */}
      <div className="mt-2 md:mt-16 flex flex-col gap-4 md:gap-8 items-center justify-center w-full">
        <p className="text-2xl md:text-4xl font-semibold text-stone-800 mb-2 w-full text-center p-4">
          Ready to relax by your private pool with a sea view?
        </p>
        <Button
          type="button"
          className="!py-3 !px-8 !font-bold uppercase bg-stone-900 hover:bg-stone-800 text-white"
          rounded="lg"
          size="xl"
          onClick={() => {
