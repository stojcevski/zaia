        ...
        <div className="relative">
          <ListboxButton as="div">
            {({ open }) => (
              <button
                className={clsx(
                  'flex h-16 w-full cursor-pointer items-center justify-between border border-gray-lighter bg-white px-4 py-2.5 text-left uppercase text-gray-dark focus:outline-none xl:py-3',
          ...
          <ListboxOptions className="absolute left-0 mt-1 grid w-full grid-cols-1 gap-3 rounded-lg border border-gray-lighter bg-white p-6 text-base shadow-lg ring-1 ring-gray-lightest">
            ...
            <ListboxOption className="mt-4" value={0}>
              <Button
                variant="solid"
                className="w-full"
                onClick={() =>
